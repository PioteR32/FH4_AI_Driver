...
# Główny tenzor [Batch=1, Channels=3, Depth=5, Height=360, Width=640]
    ...
    with torch.no_grad():
        ...
        while not keyboard.is_pressed("q"):
            ...
            images_batch = input_tensor.permute(0, 2, 1, 3, 4)
            ...
            controller.set_triggers(outputs[0][2].item(),outputs[0][1].item())
            controller.set_left_stick(outputs[0][0].item(),0)
...
if __name__ == "__main__":
    ...
    checkpoint = torch.load(r"C:\FH4_AI_Driver\model_200E32BLR0_000120.pth", map_location=device)
    
    # Wczytujemy stan modelu
